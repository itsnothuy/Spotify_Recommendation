...
const Navbar = () => {
  ...
  return (
    <nav className="w-full fixed top-0 bg-white border-gray-200 rounded-lg backdrop-blur-md dark:bg-gray-900/5 z-10 h-12 sm:h-16">
      <div className="max-w-screen flex flex-wrap items-center justify-between mx-auto p-2 sm:p-3">
        ...
        >
          <span className="text-xl sm:text-3xl font-semibold whitespace-nowrap dark:text-white">
            MusicFinder ♪
          </span>
        </a>
        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-default">
          <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-transparent dark:bg-gray-800/10 md:dark:bg-gray-900/0">
